          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 animate-[fadeIn_0.2s_ease]">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href={`https://wa.me/?text=${encodeURIComponent('Check out my trip plan: ' + shareUrl)}`}
                  target="_blank"
                ...
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-sky-50 hover:bg-sky-100 text-sky-700 font-semibold text-sm py-2.5 rounded-xl transition-colors"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Planning a trip to ' + formData.destination + ' with @GlobePlanner!')}&url=${encodeURIComponent(shareUrl)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-gray-100 text-gray-700 font-semibold text-sm py-2.5 rounded-xl transition-colors"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
